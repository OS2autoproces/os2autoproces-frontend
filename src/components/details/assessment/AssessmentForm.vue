    ...
    <div class="assessment" :class="{ disabled: state.disabled.assessmentEdit }">
      <div class="question">
        <div class="label">
          ...
          <InfoTooltip
            class="tooltip"
          >En faglig vurdering kan f.eks. være, at en sagsbehandler foretager et skøn eller tager en beslutning der har betydning for processens forløb.</InfoTooltip>
        </div>
        <LikertScale
          :disabled="state.disabled.assessmentEdit"
      ...
      <div class="question">
        <div class="label">
          ...
          <InfoTooltip
            class="tooltip"
          >Du skal her vurdere, om processen ofte bliver ændret. Det kan f.eks. skyldes ændringer i lovgivningen.</InfoTooltip>
        </div>
        <LikertScale
          :disabled="state.disabled.assessmentEdit"
      ...
      <div class="question">
        <div class="label">
          ...
          <InfoTooltip
            class="tooltip"
          >Kan processen f.eks. starte eller slutte forskelligt fra gang til gang processen udføres, eller er der forskellige udfaldsrum i løbet af processen.</InfoTooltip>
        </div>
        <LikertScale
          :disabled="state.disabled.assessmentEdit"
      ...
      <div class="question">
        <div
          class="label"
        >Er de data og informationer, der skal bruges i processen, tilgængelige digitalt i IT-systemer? *</div>
        <LikertScale
          :disabled="state.disabled.assessmentEdit"
      ...
      <div class="question">
        <div class="label">
          ...
          <InfoTooltip
            class="tooltip"
          >Her skal du vurdere, hvad en digital assistent kan betyde for serviceniveauet. Det kunne f.eks. være at borgerne vil få svar hurtigere.</InfoTooltip>
        </div>
        <LikertScale
          :disabled="state.disabled.assessmentEdit"
      ...
      <div class="question">
        <div class="label">
          ...
          <InfoTooltip
            class="tooltip"
          >Her skal du vurdere, hvad en digital assistent vil betyde for din egne trivsel som medarbejder. F.eks. ved at lette nogle af de trivielle og tidskrævende arbejdsopgaver.</InfoTooltip>
        </div>
        <LikertScale
          :disabled="state.disabled.assessmentEdit"
      ...
      <div class="question">
        <div class="label">
          ...
          <InfoTooltip
            class="tooltip"
          >Der henvises til, om det er hele processen eller nogle mindre dele af processen der kan automatiseres.</InfoTooltip>
        </div>
        <LikertScale
          :disabled="state.disabled.assessmentEdit"
